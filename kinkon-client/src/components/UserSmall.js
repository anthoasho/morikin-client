...
const UserSmall = ({username, profileImg}) => {
  return(
    <div className = "user-profile-small" >
          {profileImg ? <div className="img-wrapper">
      
   
        <img className="profile-picture" alt={`${username}'s profile `} src={profileImg} style={{border: `2px solid ${randomColor()}`}} /> </div>: 
                <PreloaderIcon
